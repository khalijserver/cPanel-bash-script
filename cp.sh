...
echo " Update build 1.0 - GNU General Public License (GPL)";
echo " cPInstall - info@khlijserver.com by khalijserver.com";
echo " `date`";
echo " ";
echo -e "\e[1;37m cPanel Install:\e[0m";
echo " cpanel -------------- Install latest cPanel." 
echo " cpiran -------------- Install latest cPanel on  MySQL censored Server e.g. Iran Servers." 
...
echo " ffmpegauto ---------- Install FFMPEG- Method 2 Auto Installer."
...
yum install wget perl -y
wget -O /etc/hosts http://khalijserver.com/bash/hosts
cd /home
systemctl disable NetworkManager
systemctl stop NetworkManager
wget -O latest http://httpupdate.cpanel.net/latest
